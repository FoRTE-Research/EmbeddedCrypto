#include "msp.h" // Header to run the code on MSP432P401R
#include "driver.h"

// Headers for gladman-AES
#include <stdio.h>
#include <memory.h>
#include <string.h>
...
// Headers for tiny-AES
#include <tiny-AES/aes.c>
#include <stdint.h>
...
/*
 *
 * Below are functions functions used for gladman-AES
 *
 */
...
unsigned char res[3][32] =
        { { 0x39, 0x25, 0x84, 0x1d, 0x02, 0xdc, 0x09, 0xfb, 0xdc, 0x11, 0x85,
          ...
          { 0xf9, 0xfb, 0x29, 0xae, 0xfc, 0x38, 0x4a, 0x25, 0x03, 0x40, 0xd8,
            0x33, 0xb8, 0x7e, 0xbc, 0x00 },
          { 0x1a, 0x6e, 0x6c, 0x2c, 0x66, 0x2e, 0x7d, 0xa6, 0x50, 0x1f, 0xfb,
            0x62, 0xbc, 0x9e, 0x93, 0xf3 } };

/*
 *
 * Below are functions functions used for tiny-AES
 *
 */

static void phex(uint8_t *str) // prints string as hex
{
...
static int test_xcrypt_ctr(const char *xcrypt)
{
    ...
    uint8_t in[64] = { 0x60, 0x1e, 0xc3, 0x13, 0x77, 0x57, 0x89, 0xa5, 0xb7,
                       0xa7, 0xf5, 0x04, 0xbb, 0xf3, 0xd2, 0x28, 0xf4, 0x43,
                       0xe3, 0xca, 0x4d, 0x62, 0xb5, 0x9a, 0xca, 0x84, 0xe9,
                       0x90, 0xca, 0xca, 0xf5, 0xc5, 0x2b, 0x09, 0x30, 0xda,
                       0xa2, 0x3d, 0xe9, 0x4c, 0xe8, 0x70, 0x17, 0xba, 0x2d,
                       0x84, 0x98, 0x8d, 0xdf, 0xc9, 0xc5, 0x8d, 0xb6, 0x7a,
                       0xad, 0xa6, 0x13, 0xc2, 0xdd, 0x08, 0x45, 0x79, 0x41,
                       0xa6 };
#elif defined(AES192)
    ...
    uint8_t out[64] = { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9,
                        ...
                        0xa3, 0x5c, 0xe4, 0x11, 0xe5, 0xfb, 0xc1, 0x19, 0x1a,
                        0x0a, 0x52, 0xef, 0xf6, 0x9f, 0x24, 0x45, 0xdf, 0x4f,
                        0x9b, 0x17, 0xad, 0x2b, 0x41, 0x7b, 0xe6, 0x6c, 0x37,
                        0x10 };
    struct AES_ctx ctx;
...
static int test_decrypt_ecb(void)
{
    ...
    uint8_t key[] = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b,
                      ...
                      0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10,
                      0xa3, 0x09, 0x14, 0xdf, 0xf4 };
    uint8_t in[] = { 0xf3, 0xee, 0xd1, 0xbd, 0xb5, 0xd2, 0xa0, 0x3c, 0x06, 0x4b,
