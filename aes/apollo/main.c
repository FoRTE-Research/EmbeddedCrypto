...
void init(void){
    ...
    //// Configure LED GPIOs for results checking
    //am_hal_gpio_pinconfig(44, g_AM_HAL_GPIO_OUTPUT);        // Green
    //am_hal_gpio_state_write(44, AM_HAL_GPIO_OUTPUT_CLEAR);

    //am_hal_gpio_pinconfig(46, g_AM_HAL_GPIO_OUTPUT);        // Red
...
int main(void)
{
  ...
  am_hal_gpio_state_write(1, AM_HAL_GPIO_OUTPUT_TOGGLE);
  am_util_delay_us(20);
  am_hal_gpio_state_write(1, AM_HAL_GPIO_OUTPUT_TOGGLE);
  am_util_delay_us(20);
  am_hal_gpio_state_write(1, AM_HAL_GPIO_OUTPUT_TOGGLE);
