...
#if defined saml11 || defined msp432p401r || defined msp430fr5994 || defined msp430f5529 || defined adafruitm0express
#include "curve.h"
#endif

#ifdef apollo3
#include "D:\AmbiqSuiteSDK-master\boards\apollo3_evb\examples\apollo3_ecc\keil\curve.h"
#endif
...
#ifdef apollo3
#include "D:\AmbiqSuiteSDK-master\boards\apollo3_evb\examples\apollo3_ecc\keil\experiment_time.h"
#endif
...
#if !defined msp430f5529 && !defined msp430fr5994
...
void init_ecc() {
    ...
    //private key
    unsigned char private_a[BUF_BYTES] = {0x78,0xfa,0x47,0x69,0xfe,0xfb,0x11,0xff,0x72,0xae,0xb3,0xb1,0x7e,0xa2,0xed,0x43,0x7d,0x55,0x4f,0xe2,0x7f,0x7c,0x43,0xef,0x25,0x72,0x5e,0xf6,0x32,0x43,0xb3,0x4e};
    unsigned char private_b[BUF_BYTES] = {0x0b,0x0f,0xc8,0xf5,0x74,0x7d,0x93,0xfd,0xb1,0xad,0x34,0x51,0x10,0xa8,0xbd,0x6e,0x6b,0x48,0x39,0x17,0x6b,0xd6,0xda,0xc6,0x46,0x39,0x6c,0x8c,0x45,0xdb,0x6a,0x41};
    //public key  (x, y)
    unsigned char cli_to_srv_x[BUF_BYTES] = {0x78,0x89,0x84,0x83,0xc2,0x45,0x68,0x8b,0xb2,0xef,0x81,0x76,0x6f,0x91,0xb5,0x42,0xa6,0x89,0xeb,0x9c,0x4a,0xd3,0xc7,0xa2,0xc0,0x15,0x71,0xe2,0x5b,0x85,0x20,0x41};
    ...
    unsigned char srv_to_cli_x[BUF_BYTES] = {0x07,0xa4,0x89,0x3c,0x38,0x20,0x30,0x21,0xa0,0x06,0x07,0x38,0x0a,0x37,0x31,0xe1,0xba,0x09,0x9e,0xb3,0x27,0xf9,0x6b,0xab,0x8a,0xfb,0xdb,0xe7,0xd2,0x15,0x2d,0x65};
...
//void loop()
{
//while(1){ //while for current measurement
#ifdef adafruitm0express
...
//  int verify = check_result();
 ...
 volatile unsigned long long int elapsed = getElapsedTime();
    ...
    char buffer[20];
    #if defined(TINY_ECC)
       sprintf(buffer, "Value: %d0\n", elapsed/10); //Dividing elapsed by 10 because int overflows. Adding 0 manually in sprintf
    #elif defined(BSD)
       sprintf(buffer, "Value: %d00\n", elapsed/100); //Dividing elapsed by 100 because int overflows. Adding 00 manually in sprintf
    #elif defined(MBEDTLS)
    ...
    UART0_puts(buffer);
      ...
      char buf[20];
    #ifdef TINY_ECC
      sprintf(buf, "Value: %d00\n", (int)(elapsed/100)); //Dividing elapsed by 100 as int(16 bit) value overflows. Adding 0 manually to print.
    #endif
    #ifdef BSD
      sprintf(buf, "Value: %d0\n", (int)(elapsed/10)); //Dividing elapsed by 100 as int(16 bit) value overflows. Adding 00 manually to print.
    #endif
    #ifdef MBEDTLS
      sprintf(buf, "Value: %d\n", (int)elapsed);
    #endif
